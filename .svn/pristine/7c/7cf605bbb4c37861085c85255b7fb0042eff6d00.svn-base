    ...
    var options = {
        ...
        callBackFun: function(data) {
            if (data.result == 0) {
                ...
                debugger;
                CloudUtils.setForm(jsonData, "projectAdjustFormDetail");
                var siteRiskInfo = jsonData.siteRiskInfo;
                if(siteRiskInfo == ''||siteRiskInfo == null){
                	$("#riskForm").hide();
                }else{
                	$("#riskForm").show();
                }
                CloudUtils.setForm(jsonData, "projectAdjustRiskFormDetail");
                CloudUtils.setForm(jsonData, "infoFormDetail");
