...
public class DykRateController extends BaseJsonController {
	...
	public @ResponseBody BaseRespBean DykRateList(HttpSession httpSession,
			@RequestBody DykRateListReqBean reqBean, BindingResult bindingResult) {
	...
	public @ResponseBody BaseRespBean UpdateDykRate(
			@Valid @RequestBody DykRate reqBean, BindingResult bindingResult)
			throws IOException {
		BaseRespBean respBean = new BaseRespBean();
	...
	@ResponseBody
	public BaseRespBean addDykRate(@Valid @RequestBody DykRate reqBean)
			throws IOException {
		return this.dykRateService.addDykRate(reqBean);
	}

	@RequestMapping(value = "/delete")
	@ResponseBody
	public BaseRespBean deleteDykRate(@Valid @RequestBody DykRate reqBean)
			throws IOException {
		return this.dykRateService.deleteDykRate(reqBean);
	}
}
