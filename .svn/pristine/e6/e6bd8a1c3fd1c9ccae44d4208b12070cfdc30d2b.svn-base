...
import com.ut.scf.reqbean.pub.BusinessTypeListPageReqBean;
...
public class PrdManagerController extends BaseJsonController {
	...
	@RequestMapping(value = "/businesslist", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean businessTypeList(HttpSession httpSession,
			@RequestBody BusinessTypeListPageReqBean reqBean, BindingResult bindingResult) {
		BaseRespBean respBean = new BaseRespBean();
		Map<String, Object> paramMap = BeanUtil.beanToMap(reqBean);
		// paramMap.put("productName",reqBean.getProductName());
		// paramMap.put("productDesc",reqBean.getProductDesc());
		...
		page.setPageNumber(reqBean.getPageNumber());
		page.setPageSize(reqBean.getPageSize());
		respBean = prdManagerService.getBusinessList(paramMap, page);
		log.debug("businessList: {}", respBean);

		return respBean;
	}
	@RequestMapping(value = "/type")
	@ResponseBody
	public String productTypeById(@RequestBody PrdListPageReqBean reqBean) {

		return prdManagerService.findTypeById(reqBean.getProductId());
	}

	@RequestMapping(value = "/add", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean productAdd(
			@Valid @RequestBody PrdAddReqBean reqBean,
	...
	@RequestMapping(value = "/businessadd", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean businessAdd(
			@Valid @RequestBody BusinessTypeReqBean reqBean,
			BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();
		if (bindingResult.hasErrors()) {
			log.warn("bindingResult has error");
		...
		Map<String, Object> paramMap = BeanUtil.beanToMap(reqBean);
		respBean = this.prdManagerService.insertBusiness(paramMap);
	...
	public @ResponseBody BaseRespBean deptUpdate(
			@Valid @RequestBody PrdUpdateReqBean reqBean,
			BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();
		if (bindingResult.hasErrors()) {
			log.warn("bindingResult has error");
	...
	@RequestMapping(value = "/businessmod", method = RequestMethod.POST, consumes = { "application/json" }, produces = { "application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean Businessmod(
			@Valid @RequestBody BusinessTypeReqBean reqBean,
			BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();
		if (bindingResult.hasErrors()) {
		...
		respBean = this.prdManagerService.updateBusiness(reqBean);
	...
	public @ResponseBody BaseRespBean deptDelete(
			@Valid @RequestBody PrdDeleteReqBean reqBean,
			BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();
		if (bindingResult.hasErrors()) {
			log.warn("bindingResult has error");
