...
public class RepayProcessReqBean extends BaseReqBean {
	...
	private String allCarInfo;
	
	private String payAmitInfo;
	...
	public void setAllCarInfo(String allCarInfo) {
		this.allCarInfo = allCarInfo;
	}

	public String getPayAmitInfo() {
		return payAmitInfo;
	}

	public void setPayAmitInfo(String payAmitInfo) {
		this.payAmitInfo = payAmitInfo;
	}
	...
	public String getRepayAutAmt() {
		return repayAutAmt;
	}

	public void setRepayAutAmt(String repayAutAmt) {
