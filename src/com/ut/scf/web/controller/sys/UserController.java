...
public class UserController extends BaseJsonController {
	...
	public @ResponseBody BaseRespBean list(HttpSession httpSession,
			@Valid @RequestBody UserSearchPageReqBean searchPage, BindingResult bindingResult) throws IOException {
	...
	@RequestMapping(value = "/listInfo", method = RequestMethod.POST, consumes = { "application/json" }, produces = {
			"application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean listInfo(HttpSession httpSession,
			@Valid @RequestBody UserSearchPageReqBean searchPage, BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();
		if (bindingResult.hasErrors()) {
			log.warn("bindingResult has error");
		...
		respBean = this.userOperService.userListInfo(searchPage);

		return respBean;
	}

	@RequestMapping(value = "/hasMenuList", method = RequestMethod.POST, consumes = { "application/json" }, produces = {
			"application/json;charset=UTF-8" })
	...
	@RequestMapping(value = "/add", method = RequestMethod.POST, consumes = { "application/json" }, produces = {
			"application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean addUser(HttpSession httpSession, @Valid @RequestBody UserAddReqBean addUserBean,
	...
	@RequestMapping(value = "/mod", method = RequestMethod.POST, consumes = { "application/json" }, produces = {
			"application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean modUser(HttpSession httpSession,
			@Valid @RequestBody UserUpdateReqBean userUpdataBean, BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();
		if (bindingResult.hasErrors()) {
			log.warn("bindingResult has error");
			respBean.setResult(ErrorCodeEnum.PARAM_VALID_ERROR);
	...
	public @ResponseBody BaseRespBean delUser(HttpSession httpSession,
			@Valid @RequestBody UserDeleteReqBean delUserBean, BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();

		if (!checkAgencyTask(delUserBean.getUserName())) {
			respBean.setResult(ErrorCodeEnum.USER_DELETE_FAIL);
			return respBean;
		}
		if (bindingResult.hasErrors()) {
			log.warn("bindingResult has error");
	...
	private boolean checkAgencyTask(String user) {

		Map<String, Object> map = new HashMap<String, Object>();
		map.put("userId", user);
		return activitiService.checkAgencyTask(map);

	}

	@RequestMapping(value = "/configKey", method = RequestMethod.POST, consumes = { "application/json" }, produces = {
			"application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean selectconfigByKey(HttpSession httpSession,
			@Valid @RequestBody SysConfigByKeyReqBean reqBean, BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();
		if (bindingResult.hasErrors()) {
			log.warn("bindingResult has error");
			respBean.setResult(ErrorCodeEnum.PARAM_VALID_ERROR);
	...
	@RequestMapping(value = "/updatePassword", method = RequestMethod.POST, consumes = {
	...
	public @ResponseBody BaseRespBean updatePassword(HttpSession httpSession,
			@Valid @RequestBody UserModPwdReqBean usrModPwdBean, BindingResult bindingResult) throws IOException {
		BaseRespBean respBean = new BaseRespBean();
		if (bindingResult.hasErrors()) {
			log.warn("bindingResult has error");
			respBean.setResult(ErrorCodeEnum.PARAM_VALID_ERROR);
	...
	@RequestMapping(value = "/resetPassword", method = RequestMethod.POST, consumes = {
			"application/json" }, produces = { "application/json;charset=UTF-8" })
	...
	@RequestMapping(value = "/bizLogList", method = RequestMethod.POST, consumes = { "application/json" }, produces = {
			"application/json;charset=UTF-8" })
	...
	@RequestMapping(value = "/changeRole", method = RequestMethod.POST, consumes = { "application/json" }, produces = {
			"application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean changeRole(HttpSession httpSession,
			@Valid @RequestBody MenuListReqBean menuListReqBean, BindingResult bindingResult) throws IOException {
		...
		httpSession.setAttribute(ScfConsts.SESSION_ROLE_ID, paramMap.get("roleId"));
		httpSession.setAttribute(ScfConsts.SESSION_REPRESENT_ID, ((UserLoginRespBean) respBean).getRepresentId());
		return respBean;
	}

	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/getSession", method = RequestMethod.POST, consumes = { "application/json" }, produces = {
			"application/json;charset=UTF-8" })
	public @ResponseBody BaseRespBean getSession(HttpSession httpSession, @RequestBody BaseReqBean reqBean) {
		...
		respBean.setUserId((String) httpSession.getAttribute(ScfConsts.SESSION_USER_ID));
		respBean.setUsername((String) httpSession.getAttribute(ScfConsts.SESSION_USERNAME));
		respBean.setRoleId((String) httpSession.getAttribute(ScfConsts.SESSION_ROLE_ID));
		respBean.setRoleName((String) httpSession.getAttribute(ScfConsts.SESSION_ROLE_NAME));
		respBean.setRoleType((int) httpSession.getAttribute(ScfConsts.SESSION_ROLE_TYPE));
		respBean.setCorpId((String) httpSession.getAttribute(ScfConsts.SESSION_CORP_ID));
		respBean.setDeptId((String) httpSession.getAttribute(ScfConsts.SESSION_DEPT_ID));
		respBean.setMenuList((List<Menu>) httpSession.getAttribute(ScfConsts.SESSION_MENU_LIST));

		return respBean;
	}

	@RequestMapping(value = "/checkSession", method = RequestMethod.GET, produces = {
			"application/json;charset=UTF-8" })
