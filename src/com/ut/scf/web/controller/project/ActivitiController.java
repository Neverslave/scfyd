...
public class ActivitiController extends BaseJsonController{
	...
	public @ResponseBody BaseRespBean deleteProcessById(
			HttpSession httpSession,
			@RequestBody ActivitiDeleteProcessReqBean reqBean,
			BindingResult bindingResult) {
		
		return activitiService.deleteProcessById(reqBean.getProcInstId());
