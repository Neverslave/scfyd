...
public class WarningServiceImpl implements IWarningService {
	...
	public BaseRespBean warningInfoDetail(WarningReqBean reqBean) {
		...
		warningInfo.setWarnStatus((byte) 1);
	...
	@Override
	@Transactional(readOnly = true)
	public int warningInfoCount(Map<String, Object> paramMap) {
		return iWarningDao.selectWarningCount(paramMap);
	}

	@Override
	public BaseRespBean warningInfoDelete(String warningId) {
		BaseRespBean respBean = new BaseRespBean();
		int deleteByPrimaryKey = warningInfoMapper.deleteByPrimaryKey(warningId);
