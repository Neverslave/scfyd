...
window.operateEvents = {
    'click .push': function (e, value, row, index) {
        store.set('recomMeet', row);
        $('#mainFrame', top.document).attr('src', 'tradfact/recomMeet/recomMeetApply.html');
    }
};
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        formatter: function (value, row, index) {
                            var s = '<a class = "fa fa-edit push" style="color:#278bdd;padding:0px 5px;" title="推荐上会" href="javascript:void(0)"></a>';
                            return s;
                        },
