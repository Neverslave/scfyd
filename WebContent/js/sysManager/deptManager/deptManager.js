...
function checkForm(){
	$('#modDeptForm').data('bootstrapValidator').validate();
	var da = $('#modDeptForm').data('bootstrapValidator');
	if (!da.isValid()) {
				...
				validators : {
					...
					callback : {
						...
						callback : function(value, validator) {
							...
							return parseFloat(value) >= 0 && parseFloat(value) <= 1000000;
						}
					}
				}
			},
